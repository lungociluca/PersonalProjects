...
var $author$project$Model$Date$withDefault = F3(
	function (def, a, f) {
		if (a.$ === 'Just') {
			var x = a.a;
			return f(x);
...
var $author$project$Model$Date$compare = F2(
	function (_v0, _v1) {
		...
		var month2 = A3($author$project$Model$Date$withDefault, 12, d2.month, $author$project$Model$Date$monthToInt);
		var month1 = A3($author$project$Model$Date$withDefault, 12, d1.month, $author$project$Model$Date$monthToInt);
		var monthDiff = month1 - month2;
		var compareYears = (!yearDiff) ? $elm$core$Basics$EQ : ((yearDiff < 0) ? $elm$core$Basics$LT : $elm$core$Basics$GT);
		return A2(
			$author$project$Model$Util$chainCompare,
			(!monthDiff) ? $elm$core$Basics$EQ : ((monthDiff < 0) ? $elm$core$Basics$LT : $elm$core$Basics$GT),
			compareYears);
	});
...
var $author$project$Model$Date$monthsBetween = F2(
	function (dA, dB) {
		var month2 = A3(
			$author$project$Model$Date$withDefault,
			-1,
			$author$project$Model$Date$month(dB),
			$author$project$Model$Date$monthToInt);
		var month1 = A3(
			$author$project$Model$Date$withDefault,
			-1,
			$author$project$Model$Date$month(dA),
			$author$project$Model$Date$monthToInt);
		var returnNothing = _Utils_eq(month1, -1) || _Utils_eq(month2, -1);
		return returnNothing ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			$elm$core$Basics$abs(
				(12 * ($author$project$Model$Date$year(dA) - $author$project$Model$Date$year(dB))) + (month1 - month2)));
	});
...
var $author$project$Model$Event$Category$getAcademic = function (_v0) {
	var a = _v0.a;
	return a.academic;
};
var $author$project$Model$Event$Category$getAward = function (_v0) {
	var a = _v0.a;
	return a.award;
};
var $author$project$Model$Event$Category$getProject = function (_v0) {
	var a = _v0.a;
	return a.project;
};
var $author$project$Model$Event$Category$getWork = function (_v0) {
	var a = _v0.a;
	return a.work;
};
var $author$project$Model$Event$Category$isEventCategorySelected = F2(
	function (category, current) {
		switch (category.$) {
			case 'Academic':
				return $author$project$Model$Event$Category$getAcademic(current);
			case 'Work':
				return $author$project$Model$Event$Category$getWork(current);
			case 'Project':
				return $author$project$Model$Event$Category$getProject(current);
			default:
				return $author$project$Model$Event$Category$getAward(current);
		}
	});
...
var $author$project$Model$Event$Category$set = F3(
	function (category, value, current) {
		var workVal = $author$project$Model$Event$Category$getWork(current);
		var projectVal = $author$project$Model$Event$Category$getProject(current);
		var awardVal = $author$project$Model$Event$Category$getAward(current);
		var academicVal = $author$project$Model$Event$Category$getAcademic(current);
		switch (category.$) {
			case 'Academic':
				return $author$project$Model$Event$Category$SelectedEventCategories(
					{academic: value, award: awardVal, project: projectVal, work: workVal});
			case 'Work':
				return $author$project$Model$Event$Category$SelectedEventCategories(
					{academic: academicVal, award: awardVal, project: projectVal, work: value});
			case 'Project':
				return $author$project$Model$Event$Category$SelectedEventCategories(
					{academic: academicVal, award: awardVal, project: value, work: workVal});
			default:
				return $author$project$Model$Event$Category$SelectedEventCategories(
					{academic: academicVal, award: value, project: projectVal, work: workVal});
		}
	});
...
var $author$project$Model$Interval$compare = F2(
	function (_v0, _v1) {
		var intA = _v0.a;
		var intB = _v1.a;
		var orderByStart = A2($author$project$Model$Date$compare, intA.start, intB.start);
		var orderByEnd = function () {
		...
		return A2($author$project$Model$Util$chainCompare, orderByEnd, orderByStart);
	});
...
var $author$project$Model$Date$view = function (_v0) {
	var d = _v0.a;
	var yearString = $elm$core$String$fromInt(d.year);
	var monthString = $author$project$Model$Date$monthToString(
		A3(
			$author$project$Model$Date$withDefault,
			$author$project$Model$Date$Jan,
			d.month,
			function (x) {
				return x;
			}));
	var toDisplay = 'Month ' + (monthString + (' Year ' + yearString));
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(toDisplay)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'Academic',
				$author$project$Model$Event$Category$getAcademic(model),
				$author$project$Model$Event$Category$Academic),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Work',
				$author$project$Model$Event$Category$getWork(model),
				$author$project$Model$Event$Category$Work),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Project',
				$author$project$Model$Event$Category$getProject(model),
				$author$project$Model$Event$Category$Project),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Award',
				$author$project$Model$Event$Category$getAward(model),
...
var $author$project$Model$Event$getEventClass = function (event) {
	return event.important ? 'event event-important' : 'event';
};
var $author$project$Model$Interval$startString = function (date) {
	var yearStr = 'Year ' + ($elm$core$String$fromInt(
		$author$project$Model$Date$year(date)) + ' ');
	var monthStr = 'Month ' + function () {
		var _v0 = $author$project$Model$Date$month(date);
		if (_v0.$ === 'Just') {
			var a = _v0.a;
			return $author$project$Model$Date$monthToString(a);
		} else {
			return ' ';
		}
	}();
	return _Utils_ap(yearStr, monthStr);
};
var $author$project$Model$Interval$endString = function (date) {
	if (date.$ === 'Nothing') {
		return 'Present';
	} else {
		var a = date.a;
		return $author$project$Model$Interval$startString(a);
	}
};
var $author$project$Model$Interval$getEnd = function (_v0) {
	var intr = _v0.a;
	return intr.end;
};
var $author$project$Model$Interval$getStart = function (_v0) {
	var intr = _v0.a;
	return intr.start;
};
var $author$project$Model$Event$intervalToString = function (interval) {
	return _Utils_ap(
		$author$project$Model$Interval$startString(
			$author$project$Model$Interval$getStart(interval)),
		$author$project$Model$Interval$endString(
			$author$project$Model$Interval$getEnd(interval)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Model$Event$getEventClass(event))
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Model$Event$intervalToString(event.interval))
							]))
					]))
			]));
};
...
var $author$project$Model$Interval$lengthString = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	return $elm$core$String$fromInt(a) + (' ' + $elm$core$String$fromInt(b));
};
var $author$project$Model$Interval$displayLength = function (interval) {
	var intervLength = $author$project$Model$Interval$length(interval);
	if (intervLength.$ === 'Just') {
		var a = intervLength.a;
		return A2(
			$elm$html$Html$p,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Model$Interval$lengthString(a))
				]));
	} else {
		return A2(
			$elm$html$Html$p,
...
var $author$project$Model$Interval$view = function (interval) {
	var startInterval = $author$project$Model$Interval$getStart(interval);
	var endInterval = $author$project$Model$Interval$getEnd(interval);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Model$Interval$startString(startInterval))
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Model$Interval$endString(endInterval))
					])),
				$author$project$Model$Interval$displayLength(interval)
			]));
};
				...
				A2(
					...
					function (record) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(record.detail)
								]));
					},
					details.contacts)),
				A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href(record.detail)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(record.name)
										]))
								]));
					},
					details.socials))
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['E:\\Elm_assig\\tests\\DateTests.elm', 'E:\\Elm_assig\\tests\\EventCategoryTests.elm', 'E:\\Elm_assig\\tests\\EventTests.elm', 'E:\\Elm_assig\\tests\\IntervalTests.elm', 'E:\\Elm_assig\\tests\\PersonalDetailsTests.elm', 'E:\\Elm_assig\\tests\\RepoTests.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare1.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare2.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare3.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare4.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\Compare5.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween1.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween2.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween3.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween4.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween5.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetween6.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetweenMonths0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetweenMonths1.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Date\\MonthsBetweenMonths2.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Event\\Category\\AllSelected0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Event\\Category\\IsEventCategorySelected0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Event\\Category\\Set0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Event\\Category\\Set1.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Interval\\Compare0.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Interval\\Compare1.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Interval\\Compare2.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Interval\\Compare3.elm', 'E:\\Elm_assig\\tests\\VerifyExamples\\Model\\Interval\\Compare4.elm']),
		processes: 16,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-10660-1";
var net = require('net'),
